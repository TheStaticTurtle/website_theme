...
**The main thing you NEED to remember with this list is that it is not exhaustive. It's there as an indication of what tools and solutions I worked with in my personal, proffesional or assiosiative projects and activities.**
...
### Software devellopment
#### {{< mdi "mdi-database" >}}  Technologies
 - Languages:
   - Prefered: ``Python``, or ``C`` / ``C++``
 ...
 - Messengers:
   - PubSub: [``MQTT``](https://mqtt.org/) (traditional and with websockets) / [``ZMQ``](https://zeromq.org/)
 - Windows fuckury:
   - Custom [SNMP agent extention](https://learn.microsoft.com/en-us/windows/win32/snmp/snmp-functions) to add monitoring to a software
   - Per user local policy based on registry configurationn applied at logon


#### {{< mdi "mdi-code-braces" >}}  Software
 - IDEs / Editors:
   - Prefered: [``Jetbrains IDEs``](https://www.jetbrains.com/) / [``VSCode``](https://code.visualstudio.com/)
...
#### {{< mdi "mdi-cpu-64-bit" >}}  Chips
 ...
 - IC:
   ...
   - Other: Signal converters (ie ``MAX485``), Interfaces (ie ``FT232``), ect.

#### {{< mdi "mdi-desktop-classic" >}}  Software
 - IDEs / Editors:
   - Prefered: ``VSCode`` (with the appropriate module: [``ESP-IDF``](https://docs.espressif.com/projects/esp-idf/en/latest/esp32/get-started/)/[``Pico-SDK``](https://github.com/raspberrypi/pico-sdk)/[``PlatformIO``](https://platformio.org/))
...
#### {{< mdi "mdi-apps" >}} Software solutions
 ...
 - Webservers: [``Caddy``](https://caddyserver.com/) / [``Apache``](https://httpd.apache.org/) / [``NGINX``](https://www.nginx.com/)
 ...
 - Code managment: [``Gitlab``](https://about.gitlab.com/) / [``Gitea``](https://about.gitea.com/)
 - Voice:
   - [``FreePBX``](https://www.freepbx.org/) (In combinaison with a SPA3102 and softphones)
 - Document handling & Documentation:
   - [``Paperless-NGX``](https://github.com/paperless-ngx/paperless-ngx)
   - [``Kiwix``](https://www.kiwix.org/)
   - [``Docuwiki``](https://www.dokuwiki.org/dokuwiki) (including theme devellopment)

### Radio & Space 
#### {{< mdi "mdi-radio-tower" >}} Radio
 - Basic knowledge in radiocommunications
